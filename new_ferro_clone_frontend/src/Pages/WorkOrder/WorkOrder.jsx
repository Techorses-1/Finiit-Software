...
const WorkOrder = () => {
    ...
    const handleBulkUpload = async (event) => {
        ...
        try {
            ...
            const response = await axios.post(
                `${import.meta.env.VITE_API_URL}/workorder/bulk-upload`,
                formData,
                {
                    headers: {
            ...
            if (data.errors && data.errors.length > 0) {
                ...
                toast.success(
                    `✅ ${data.insertedCount} Work Orders uploaded successfully\n❌ ${errorCount} errors found`,
                    {
                        autoClose: 8000,
                        closeOnClick: false,
                    }
                ...
                console.log('📋 Work Order Bulk Upload Results:');
                console.log(`✅ Successfully uploaded: ${data.insertedCount}`);
                console.log(`📊 Total Work Orders processed: ${data.totalWorkOrders}`);
                console.log(`📝 Total rows: ${data.totalRows}`);
                console.log('🎯 Successful Work Orders:', data.workOrderNumbers);
                ...
                toast.success(`🎉 All ${data.insertedCount} work orders uploaded successfully!`);
            }
            ...
            if (error.response?.data?.errors) {
                ...
                toast.error(
                    `Upload completed with issues. ${errorData.insertedCount || 0} Work Orders uploaded, ${errorData.errors.length} errors. Check console for details.`,
                    { autoClose: 8000 }
                );
                console.log('Upload errors:', errorData.errors);
            } else {
                toast.error(error.response?.data?.message || 'Error uploading work orders');
            }
        } finally {
    ...
    const initialValues = {
        ...
        receiver: {
            ...
            gstin: "",
            address: "",
            address2: "", // NEW: Add address2 field
            city: "",
            pincode: "",
            contact: "",
            email: "",
    ...
    const handleCompanySelect = (selectedOption, setFieldValue) => {
        if (selectedOption) {
            ...
            setFieldValue("receiver.address2", selectedCustomer.address2 || ""); // NEW: Add address2
    ...
    const WorkOrderModal = ({ workOrder, customers, bomProducts, onClose, onExport, onUpdate, onDelete }) => {
        ...
        // Handler function for company selection in WorkOrderModal
            ...
            if (selectedOption) {
                ...
                setEditedWorkOrder(prev => ({
                    ...
                    receiver: {
                        ...
                        address2: selectedCustomer.address2 || "", // NEW: Add address2
                        ...
                        <div className="wo-details-grid">
                            ...
                            <div className="detail-row">
                                ...
                                <span className="detail-value">
                                    {editedWorkOrder.receiver?.address2 || workOrder.receiver.address2 || "N/A"}
                                </span>
                            </div>
